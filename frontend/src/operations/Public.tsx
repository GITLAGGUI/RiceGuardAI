...
function Hero() {
  const heroMessages = [
    "Mabuhay, mga ka-farmer!",
    "Welcome sa RiceGuardAI.",
    "Ako ang inyong AI field assistant.",
    "Magtanong tungkol sa BLB at Brown Spot.",
    "Handa akong tumulong sa field updates.",
  ];
